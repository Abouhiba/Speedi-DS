// figma node: 3:3822 Component 70
export function Component70(_p = {}) {
  const props = _p;
  return (
    <div className={props.className} style={{
      ...
      <div style={{
        ...
        width: 213,
        height: 46,
        borderRadius: 7.692307472229004,
        boxShadow: "inset 0 0 0 1.923px rgb(42,167,56)",
        display: "flex",
        flexDirection: "row",
        gap: 19,
        ...
        <span style={{
          ...
          flexShrink: 0,
          alignSelf: "stretch",
        }}>{props.text1 ?? "Product Label"}</span>
      </div>
      <div style={{
        position: "absolute",
        left: 12,
        ...
        <span style={{
          ...
          color: "rgb(0,0,0)",
          flexShrink: 0,
        }}>{props.text2 ?? "Thai Chanee Durian, ripens naturally in 2–3 days, 1000g–1500g per piece"}</span>
      </div>
      <div style={{
        position: "absolute",
        left: 31,
      ...
      <div style={{
        ...
        <span style={{
          ...
          color: "rgb(144,144,144)",
          flexShrink: 0,
        }}>Product Description Area,Product Description Area,Product Description Area</span>
      </div>
    </div>
  );
}
